...
public class PublisherDAO extends BaseDAO<Publisher> {
	...
	public void update(Publisher pub) throws Exception {
		save("update tbl_publihser set publihserName=?, publisherAddress=?, publisherPhone=? where publisherId=?",
	...
	public void delete(Publisher pub) throws Exception {
		save("delete from tbl_publisher where publihserId = ?",
				new Object[] { pub.getPublisherId()});
	}

	//SELECT ALL
	public List<Publisher> readAll() throws Exception {
		return read("select * from tbl_publihser", null);
	}

	//SELECT ONE
	public Publisher readOne(int publisherId) throws Exception {

		List<Publisher> publisher = read("select * from tbl_publihser", new Object[] {publisherId});
