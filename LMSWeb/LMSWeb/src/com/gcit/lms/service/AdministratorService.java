...
public class AdministratorService {
	...
	public List<LibraryBranch> searchBranches(String searchString) throws Exception{
		Connection conn = ConnectionUtil.createConnection();
		LibraryBranchDAO lbDAO = new LibraryBranchDAO(conn);
		return lbDAO.readByBranchName(searchString);
	}

	
	public List<LibraryBranch> readBranches(int pageNo, int pageSize) throws Exception {
		Connection conn = ConnectionUtil.createConnection();
		LibraryBranchDAO lbDAO = new LibraryBranchDAO(conn);
	...
	public List<Borrower> searchBorrowers(String searchString) throws Exception{
		Connection conn = ConnectionUtil.createConnection();
		BorrowerDAO bDAO = new BorrowerDAO(conn);
		return bDAO.readByBorrowerName(searchString);
	}
