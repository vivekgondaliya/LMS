...
<body role="document">
		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<!-- <li class="dropdown">
              <a href="http://getbootstrap.com/examples/theme/#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Choose Role: <span class="caret"></span></a>
	...
	<div id="global-zeroclipboard-html-bridge"
		...
		<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"
			...
			<param name="movie"
				value="/assets/flash/ZeroClipboard.swf?noCache=1436286038121">
			...
			<embed src="/assets/flash/ZeroClipboard.swf?noCache=1436286038121"
	...
	<svg xmlns="http://www.w3.org/2000/svg" width="1140" height="500"
		...
		<text x="0" y="57"
			style="font-weight:bold;font-size:57pt;font-family:Arial, Helvetica, Open Sans, sans-serif">Thirdslide</text></svg>
</body>
</html>